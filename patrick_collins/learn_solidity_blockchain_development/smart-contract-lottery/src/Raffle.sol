...
contract Raffle is VRFConsumerBaseV2 {
    ...
    constructor(
        ...
        uint256 entranceFee,
        uint256 interval
    ) VRFConsumerBaseV2(vrfCoordinater) {
        i_entranceFee = entranceFee;
        i_interval = interval;
        i_vrfCoordinater = VRFCoordinatorV2Interface(vrfCoordinater);
        i_gasLane = gasLane;
     ...
     * if it is time to performan upkeep. The following should be true for this to return:
